...
# fix #249067
Patch6: dosfstools-2.11-geom0.patch
...
install -m 644 %{SOURCE8} %{buildroot}%{_mandir}/man8/dosfslabel.8
...
%changelog
* Thu Nov  5 2009 Stepan Kasal <skasal@redhat.com> - 2.11-9
- add missing manual pages

* Wed Nov  4 2009 Stepan Kasal <skasal@redhat.com> - 2.11-8
- if the reported geometry is incorrect, use the default one
  Resolves: #249067
- fix debuginfo
  Resolves: #469842
- add url tag, improve buildroot tag, add mkdosfs-ygg provide

* Wed Oct 22 2008 Stepan Kasal <skasal@redhat.com> - 2.11-7
- Fix exit code of extfslabel.
  Resolves: #468162, 468784, 465460
